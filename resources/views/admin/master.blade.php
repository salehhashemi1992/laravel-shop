        ...
        <div class="sidebar-wrapper active">
            <div class="sidebar-header">
                <div class="d-flex justify-content-between">
                    <div class="logo">
                        <a href="index.html"><img src="{{$base}}/theme/images/logo/logo.png" alt="Logo" srcset=""></a>
                    </div>
                    <div class="toggler">
                                        ...
                                        <div class="col-6">
                                            <div class="d-flex align-items-center">
                                                <svg class="bi text-primary" width="32" height="32" fill="blue"
                                                     style="width:10px">
                                                    <use
                                                        xlink:href="/theme/vendors/bootstrap-icons/bootstrap-icons.svg#circle-fill" />
                                                </svg>
                                        ...
                                        <table class="table table-hover table-lg">
                                                ...
                                                <td class="col-3">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-md">
                                                            <img src="{{$base}}/theme/images/faces/5.jpg">
                                                        </div>
                                            ...
                                            <tr>
                                                <td class="col-3">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-md">
                                                            <img src="{{$base}}/theme/images/faces/2.jpg">
                                                        </div>
                        ...
                        <div class="card-body py-4 px-5">
                            <div class="d-flex align-items-center">
                                <div class="avatar avatar-xl">
                                    <img src="{{$base}}/theme/images/faces/1.jpg" alt="Face 1">
                                </div>
                                <div class="ms-3 name">
                        ...
                        <div class="card-content pb-4">
                            <div class="recent-message d-flex px-4 py-3">
                                <div class="avatar avatar-lg">
                                    <img src="{{$base}}/theme/images/faces/4.jpg">
                                </div>
                                <div class="name ms-4">
